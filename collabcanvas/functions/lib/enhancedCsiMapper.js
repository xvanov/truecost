 ...
 */
function buildEnhancedCSIItems(quantities, context) {
    ...
    const isExcluded = (type) => {
        var _a;
        return ((_a = cc.exclusions) === null || _a === void 0 ? void 0 : _a[type]) === true;
    };
    // Helper function to check if something is explicitly included
    const isIncluded = (type) => {
        var _a;
        return ((_a = cc.inclusions) === null || _a === void 0 ? void 0 : _a[type]) === true;
    };
    // Helper function to get area based on relationship
    const getAreaForRelationship = (relationship) => {
        switch (relationship) {
            case 'same_as_floor':
    ...
    const demolitionArea = getAreaForRelationship((_a = cc.areaRelationships) === null || _a === void 0 ? void 0 : _a.demolitionArea);
    const ceilingArea = getAreaForRelationship((_b = cc.areaRelationships) === null || _b === void 0 ? void 0 : _b.ceilingArea);
    const paintWallsOnly = ((_c = cc.areaRelationships) === null || _c === void 0 ? void 0 : _c.paintArea) === 'walls_only';
    ...
    if (!isExcluded('demolition')) {
        ...
        if (isRemodel && effectiveDemoArea > 0) {
            ...
            items.div02_existing_conditions.push({
                ...
                confidence: demolitionArea > 0 ? 1.0 : 0.85,
    ...
    if (quantities.totalWallLength > 0) {
        ...
        if (context.projectType.includes('kitchen')) {
            items.div06_wood_plastics_composites.push({
                ...
                quantity: quantities.totalWallLength * 0.6,
                unit: 'lf',
    ...
    if (context.projectType.includes('kitchen') || context.projectType.includes('bathroom')) {
        ...
        if (context.projectType.includes('kitchen')) {
            ...
            items.div06_wood_plastics_composites.push({
                ...
                item: 'Upper Cabinets',
                subdivisionCode: '06 41 00',
                quantity: cabinetLinearFeet * 0.85,
                unit: 'lf',
                unitDescription: 'linear feet of cabinet face',
                specifications: getFinishSpec('cabinets', context.finishLevel),
                confidence: 0.75,
    ...
    if (quantities.doors.length > 0) {
        ...
        const doorSource = doorStyle ? 'user_input' : 'cad_extraction';
    ...
    if (!isExcluded('electrical')) {
        ...
        if (quantities.totalRoomCount > 0) {
            items.div26_electrical.push({
                ...
                item: 'Light Switches',
                subdivisionCode: '26 27 26',
                quantity: Math.ceil(quantities.totalRoomCount * 1.5),
                unit: 'each',
        ...
        if (context.projectType.includes('kitchen')) {
            items.div26_electrical.push({
                ...
                subdivisionCode: '26 51 00',
                quantity: quantities.totalWallLength * 0.4,
                unit: 'lf',
...
exports.buildEnhancedCSIItems = buildEnhancedCSIItems;
// ===================
// HELPER FUNCTIONS
// ===================
/**
 ...
 */
function estimateOutletCount(quantities, projectType) {
 ...
 */
function getFinishSpec(itemType, finishLevel) {
    var _a, _b;
    const specs = {
        cabinets: {
    ...
    return ((_a = specs[itemType]) === null || _a === void 0 ? void 0 : _a[finishLevel]) || ((_b = specs[itemType]) === null || _b === void 0 ? void 0 : _b.mid_range) || 'Per specifications';
}
/**
 ...
 */
function getDoorSpecWithSize(finishLevel) {
    ...
    return Object.assign(Object.assign({}, selected), { trimLf });
}
/**
 ...
 */
function getWindowSpecWithSize(finishLevel) {
    ...
    const selected = specs[finishLevel] || specs.mid_range;
    return Object.assign(Object.assign({}, selected), { trimLf, sillWidth });
}
//# sourceMappingURL=enhancedCsiMapper.js.map