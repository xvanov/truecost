      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        {productNames.length === 0 && !isProcessing && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Materials to Compare</h3>
        ...
        {progress && progress.results.length > 0 && (
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Retailers Compared</h4>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Lowe's</span>
              </div>
            </div>
